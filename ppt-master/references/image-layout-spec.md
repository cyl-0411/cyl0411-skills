...
```bash
"<PPT_PYTHON>" -X utf8 scripts/analyze_images.py <project_path>/images                    # Default: PPT 16:9
"<PPT_PYTHON>" -X utf8 scripts/analyze_images.py <project_path>/images --canvas ppt43     # PPT 4:3
"<PPT_PYTHON>" -X utf8 scripts/analyze_images.py <project_path>/images --canvas xiaohongshu  # Xiaohongshu
```
