...
- Default mode: `edge-tts` is installed (`"<PPT_PYTHON>" -X utf8 -m pip install edge-tts`).
...
```bash
"<PPT_PYTHON>" -X utf8 skills/ppt-master/scripts/notes_to_audio.py --list-voices --locale <locale>
```

**ElevenLabs backend**:

```bash
"<PPT_PYTHON>" -X utf8 skills/ppt-master/scripts/notes_to_audio.py --provider elevenlabs --list-voices
```

**Cloud providers using explicit voice IDs/names**:

```bash
"<PPT_PYTHON>" -X utf8 skills/ppt-master/scripts/notes_to_audio.py --provider minimax --list-voices
"<PPT_PYTHON>" -X utf8 skills/ppt-master/scripts/notes_to_audio.py --provider qwen --list-voices
"<PPT_PYTHON>" -X utf8 skills/ppt-master/scripts/notes_to_audio.py --provider cosyvoice --list-voices
```
...
"<PPT_PYTHON>" -X utf8 skills/ppt-master/scripts/notes_to_audio.py <project_path> \
...
"<PPT_PYTHON>" -X utf8 skills/ppt-master/scripts/svg_to_pptx.py <project_path> \
...
- (If skipped embedding) one-line hint on how to embed later: `"<PPT_PYTHON>" -X utf8 skills/ppt-master/scripts/svg_to_pptx.py <project_path> --recorded-narration audio`.
