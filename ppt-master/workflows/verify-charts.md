...
5. Run the matching calculator command:
   ...
   "<PPT_PYTHON>" -X utf8 skills/ppt-master/scripts/svg_position_calculator.py calc bar \
   ...
   "<PPT_PYTHON>" -X utf8 skills/ppt-master/scripts/svg_position_calculator.py calc line \
   ...
   "<PPT_PYTHON>" -X utf8 skills/ppt-master/scripts/svg_position_calculator.py calc pie \
   ...
   "<PPT_PYTHON>" -X utf8 skills/ppt-master/scripts/svg_position_calculator.py calc radar \
...
```bash
"<PPT_PYTHON>" -X utf8 skills/ppt-master/scripts/svg_quality_checker.py <project_path>
```
...
```bash
"<PPT_PYTHON>" -X utf8 skills/ppt-master/scripts/total_md_split.py <project_path>
"<PPT_PYTHON>" -X utf8 skills/ppt-master/scripts/finalize_svg.py <project_path>
