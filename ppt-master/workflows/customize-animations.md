...
```bash
"<PPT_PYTHON>" -X utf8 skills/ppt-master/scripts/animation_config.py list-groups <project_path>
```
...
```bash
"<PPT_PYTHON>" -X utf8 skills/ppt-master/scripts/animation_config.py scaffold <project_path>
```
...
```bash
"<PPT_PYTHON>" -X utf8 skills/ppt-master/scripts/animation_config.py validate <project_path>
```
