...
"<PPT_PYTHON>" -X utf8 -m playwright install chromium

# 2. live-preview server running for this project (provides inlined SVG fetch)
"<PPT_PYTHON>" -X utf8 skills/ppt-master/scripts/svg_editor/server.py <project_path> --no-browser
...
```bash
"<PPT_PYTHON>" -X utf8 skills/ppt-master/scripts/visual_review.py <project_path>
```
