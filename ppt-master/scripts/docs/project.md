...
"<PPT_PYTHON>" -X utf8 scripts/project_manager.py import-sources <project_path> <source1> [<source2> ...]
"<PPT_PYTHON>" -X utf8 scripts/project_manager.py validate <project_path>
"<PPT_PYTHON>" -X utf8 scripts/project_manager.py info <project_path>
```
...
```bash
"<PPT_PYTHON>" -X utf8 scripts/project_manager.py init my_presentation --format ppt169
"<PPT_PYTHON>" -X utf8 scripts/project_manager.py validate projects/my_presentation_ppt169_20251116
"<PPT_PYTHON>" -X utf8 scripts/project_manager.py info projects/my_presentation_ppt169_20251116
```
...
```bash
"<PPT_PYTHON>" -X utf8 scripts/project_utils.py <project_path>
```
...
```bash
"<PPT_PYTHON>" -X utf8 scripts/batch_validate.py examples
"<PPT_PYTHON>" -X utf8 scripts/batch_validate.py examples projects
"<PPT_PYTHON>" -X utf8 scripts/batch_validate.py --all
"<PPT_PYTHON>" -X utf8 scripts/batch_validate.py examples --export
```
...
```bash
"<PPT_PYTHON>" -X utf8 scripts/generate_examples_index.py
"<PPT_PYTHON>" -X utf8 scripts/generate_examples_index.py examples
```
...
"<PPT_PYTHON>" -X utf8 scripts/pptx_template_import.py <template.pptx> -o <output_dir>
"<PPT_PYTHON>" -X utf8 scripts/pptx_template_import.py <template.pptx> --manifest-only
"<PPT_PYTHON>" -X utf8 scripts/pptx_template_import.py <template.pptx> --skip-manifest
"<PPT_PYTHON>" -X utf8 scripts/pptx_template_import.py <template.pptx> --embed-images
"<PPT_PYTHON>" -X utf8 scripts/pptx_template_import.py <template.pptx> --inheritance-mode both
"<PPT_PYTHON>" -X utf8 scripts/pptx_template_import.py <template.pptx> --inheritance-mode flat
"<PPT_PYTHON>" -X utf8 scripts/pptx_template_import.py <template.pptx> --inheritance-mode layered
```
...
```bash
"<PPT_PYTHON>" -X utf8 scripts/error_helper.py
"<PPT_PYTHON>" -X utf8 scripts/error_helper.py missing_readme
"<PPT_PYTHON>" -X utf8 scripts/error_helper.py missing_readme project_path=my_project
```
