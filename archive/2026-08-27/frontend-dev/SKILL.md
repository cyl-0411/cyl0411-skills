...
description: |
  ...
  Use when: building complete landing pages, marketing sites, or product pages
  from scratch as a heavy pipeline — including AI-generated media assets
  (image/video/audio/music), conversion copywriting, generative art, or
  cinematic scroll/animation systems. For lightweight single components,
  one-off pages, or beautifying existing UI, use frontend-design instead.
license: MIT
metadata:
  version: "1.0.0"
  category: frontend
